...
simulation_id = '_PF_22_09_22_'     ## give new id for performing simulation on same mesh with different setting (to save in a different folder)
expname = basemeshname+ simulation_id

### for outputfiles 
respath = '/data/OG2111300'
...
"""
# results_u_0.0002115000000000047_ind_4229.npz 
resume_simulation = True

resume_path = r'/data/OG2111300/lip_visco_results/tdcb_v1_LF_/results/results_u_0.0002115000000000047_ind_4229.npz'
resume_path2 = r'/data/OG2111300/lip_visco_results/tdcb_v1_LF_/force_disp.npz'
resume_disp = 0.0002115000000000047   ## can extract from the file name of resume_path
"""
...
alternedsolveroptions= {'abstole':1.e-6, 'reltole':1.e-6, 'deltadtol':1.e-3, 'max_iter': 100}
