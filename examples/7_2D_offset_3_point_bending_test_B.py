...
simulation_id = str(1)+'_LF_v1_22_09_22'     ## give new id for performing simulation on same mesh with different setting (to save in a different folder)
...
alternedsolveroptions= {'abstole':1.e-8, 'reltole':1.e-5, 'deltadtol':1.e-3, 'max_iter': 80}
